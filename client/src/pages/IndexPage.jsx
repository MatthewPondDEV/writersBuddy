...
useEffect(() => {
    if(!logOrReg) {
        document.getElementById('create-or-login').style.display = 'none'
    } else {
        document.getElementById('create-or-login').style.display = 'flex'
    }
},[logOrReg])

    return (
        <Container fluid>
            <Row style={{background:'linear-gradient(to bottom right,#fffff2,#ffbd59)'}}>
            ...
            <Row sm md id='index-background'>
                ...
                <Col className= 'text-white'>
                    ...
                    <p className='mt-1' style={{background: 'rgba(0, 0, 0, 0.75)', padding: '6px',  borderRadius: '5px'}}>
                        <strong>Writer's buddy</strong> is here to help you brainstorm, organize, and craft your next novel, manga, or short-story. The perfect buddy for story-tellers.
                    </p>
                    </div>
                </Col>
                <Col sm={12} md={12} lg={5} xl={4} xxl={3} className='text-white'>
                    <div style={{background: 'rgba(0, 0, 0, 0.75)', boxShadow:'0 0 15px #ffffff', borderRadius: '20px'}} className= 'my-5 text-center'>
                    <div id='create-or-login' style={{display: 'flex', flexDirection: 'column'}}>
                    <span className='m-3 mt-4'>Login or create account to begin</span>
                    <Button variant="primary" className='mb-5 mx-5 orange' size="md" 
                        onClick={() => {
                            setLoadLogin(true)
                            setLogOrReg(false)
                    }}>
                    ...
                    <span> - or - </span>
                    <Button variant="primary mx-5 my-5" size="md" 
                        onClick={() => {
            ...
            <Row id='index-row' className='py-3' style={{background:'#fffff2'}}>
                ...
                <Col xs={12} sm={6} xxl={3} className='text-center mt-3'>
                    <h3>Manga/Comic</h3>
                    <Image src={mangaImg} className='my-3 rounded-circle' style={{height: '300px', boxShadow:'0 0 15px #ffffff', width: '85%'}}/>
                </Col>
                <Col xs={12} sm={6} xxl={3} className='text-center mt-3'>
                    <h3>Novel</h3>
                    <Image src={novelImg} className='my-3 rounded-circle' style={{height: '300px', boxShadow:'0 0 15px #ffffff', width: '85%'}}/>
                </Col>
                <Col xs={12} sm={6} xxl={3} className='text-center mt-3'>
                    <h3>Play-write</h3>
                    <Image src={playwriteImg} className='my-3 rounded-circle' style={{height: '300px', boxShadow:'0 0 15px #ffffff', width: '85%'}}/>
                </Col>
                <Col xs={12} sm={6} xxl={3} className='text-center mt-3'>
                    <h3>Short Story</h3>
                    <Image src={shortStoryImg} className='my-3 rounded-circle' style={{height: '300px', boxShadow:'0 0 15px #ffffff', width: '85%'}}/>
                </Col>
