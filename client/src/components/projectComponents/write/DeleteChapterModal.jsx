...
export default function DeleteChapterModal({
  ...
  async function deleteChapter() {
    const response = await fetch("http://localhost:5000/deleteChapter", {
      method: "DELETE",
      headers: {
    ...
    >
      ...
      <Modal.Body>
        <h5 className="text-center py-4">
          Are you sure you want to delete this chapter from your project?
        </h5>
        <div className="d-flex justify-content-end border-top ">
          <Button variant="secondary me-3 mt-3" onClick={handleClose}>
            Cancel
          </Button>
          <Button variant="danger mt-3" onClick={deleteChapter}>
            Delete
          </Button>
        </div>
      </Modal.Body>
